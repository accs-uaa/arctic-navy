# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Extract covariates for cover transfer
# Author: Timm Nawrocki
# Last Updated: 2026-03-20
# Usage: Must be executed in a Python 3.12+ installation.
# Description: "Extract covariates for cover transfer" extracts covariate data to the sample points containing the sampled foliar cover data for transfer learning.
# ---------------------------------------------------------------------------
...
image_path = f'{asset_path}/image_data/{region}_Imagery_20200714_0p5m_3338'
