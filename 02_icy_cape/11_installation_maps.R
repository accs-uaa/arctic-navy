...
# Define input files
imagery_input = path(imagery_folder, 'IcyCape_Imagery_20200714_0.5m_3338.tif')
installation_input = path(region_folder, 'IcyCape_Installation_3338.shp')
coast_input = path(region_folder, 'IcyCape_CoastalZone_3338.shp')
vegtype_input = path(vegetation_folder, 'IcyCape_Vegetation_2020_0.5m_3338.tif')
vegcomplex_input = path(vegetation_folder, 'IcyCape_Vegetation_2020_900mmu_2m_3338.tif')

# Define output files
figure_output = path(output_folder, 'IcyCape_VegetationMaps_2020.jpg')
