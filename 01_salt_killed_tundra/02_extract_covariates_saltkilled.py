...
# Define input data
training_points = ee.FeatureCollection(f'{asset_path}/{export_prefix}/NorthSlope_SaltKilled')
...
print(f'{asset_path}/{export_prefix}/NorthSlope_SaltKilled_Covariates')
task = ee.batch.Export.table.toAsset(
    collection=training_data,
    description='northslope-saltkilled-covariates',
    assetId=f'{asset_path}/{export_prefix}/NorthSlope_SaltKilled_Covariates'
)
