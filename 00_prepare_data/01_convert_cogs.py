# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Create cloud-optimized geotiffs for distance covariates
# Author: Timm Nawrocki
# Last Updated: 2026-03-19
# Usage: Must be executed in a Python 3.12+ installation.
# Description: 'Create cloud-optimized geotiffs for distance covariates' creates cloud-optimized geotiff versions of distance covariates for use as COG-backed assets in Google Earth Engine.
# ---------------------------------------------------------------------------
...
input_folder = os.path.join(project_folder, 'Data_Input/distance_data/processed')
output_folder = os.path.join(project_folder, 'Data_Input/distance_data/cog')

# Define input files
input_files = sorted(glob.glob(f'{input_folder}/*3338.tif'))
