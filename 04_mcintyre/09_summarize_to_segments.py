...
coastal_input = os.path.join(input_folder, f'{region}_CoastalZone_2m_3338.tif')
dune_input = os.path.join(input_folder, f'{region}_Dunes_2m_3338.tif')
...
rescaled_array = np.where(is_complex & np.isin(rescaled_array, [147, 151, 152]),
