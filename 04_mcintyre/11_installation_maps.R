# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# McIntyre map results
# Author: Timm Nawrocki, Alaska Center for Conservation Science
# Last Updated: 2026-04-24
# Usage: Must be executed in a R 4.4.3+ installation.
# Description: 'McIntyre map results' creates a map figure for publication that shows the imagery, 0.5 m vegetation types, and 2 m vegetation types.
# ---------------------------------------------------------------------------
...
# Define input files
imagery_input = path(imagery_folder, 'McIntyre_Imagery_20220803_0.5m_3338.tif')
installation_input = path(region_folder, 'McIntyre_Installation_3338.shp')
coast_input = path(region_folder, 'McIntyre_CoastalZone_3338.shp')
vegtype_input = path(vegetation_folder, 'McIntyre_Vegetation_2022_0.5m_3338.tif')
vegcomplex_input = path(vegetation_folder, 'McIntyre_Vegetation_2022_900mmu_2m_3338.tif')

# Define output files
figure_output = path(output_folder, 'McIntyre_VegetationMaps_2022.jpg')
