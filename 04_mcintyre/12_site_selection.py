# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Monitoring site selection for Point McIntyre
# Author: Timm Nawrocki
# Last Updated: 2026-04-23
# Usage: Execute in Python 3.9+.
# Description: 'Monitoring site selection for Point McIntyre' selects long-term monitoring sites based on random points distributed within strata, which correspond to map classes in the 1:10,000 scale map.
# ---------------------------------------------------------------------------
...
min_distance_all = 60
omitted_values = [173, 174, 176, 177] # Omit sampling from infrastructure and water
seed = 3
...
# Apply manual updates to NVMC-010
if 'NVMC-010' in site_data['site_code'].values:
    row_idx_013 = site_data['site_code'] == 'NVMC-010'
    site_data.loc[row_idx_013, 'geometry'] = Point(203050.92, 2277324.71)
    site_data.loc[row_idx_013, 'value'] = 159
    site_data.loc[row_idx_013, 'stratum'] = value_labels.get(159, 'Unknown')
    site_data.loc[row_idx_013, 'modified'] = 'true'
else:
    print('Notice: NVMC-010 not found. Override skipped.')

# Apply manual updates to NVMC-012
if 'NVMC-012' in site_data['site_code'].values:
    row_idx_002 = site_data['site_code'] == 'NVMC-012'
    site_data.loc[row_idx_002, 'geometry'] = Point(203170.07, 2277196.52)
    site_data.loc[row_idx_002, 'value'] = 163
    site_data.loc[row_idx_002, 'stratum'] = value_labels.get(163, 'Unknown')
    site_data.loc[row_idx_002, 'modified'] = 'true'
else:
    print('Notice: NVMC-012 not found. Override skipped.')
