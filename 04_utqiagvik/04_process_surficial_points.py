...
# Description: 'Process surficial points for Icy Cape' combines manually delineated training data into a single table and ingests the table as an Earth Engine asset.
# ---------------------------------------------------------------------------
