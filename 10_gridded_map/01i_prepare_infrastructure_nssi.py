# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Prepare infrastructure NSSI data
# Author: Timm Nawrocki
# Last Updated: 2026-01-06
# Usage: Execute in Python 3.9+.
# Description: "Prepare infrastructure NSSI data" extracts infrastructure (North Slope Science Initiative) raster to common extent, mask, grid, and cell size.
# ---------------------------------------------------------------------------
...
input_folder = os.path.join(project_folder,
                            'Data_Input/ancillary_data/Infrastructure_NSSI/unprocessed')
output_folder = os.path.join(project_folder,
                             'Data_Input/ancillary_data/Infrastructure_NSSI/processed')

# Define input files
area_input = os.path.join(project_folder, 'Data_Input/ArcticCoastal_MapDomain_10m_3338.tif')
infra_input = os.path.join(input_folder, 'ArcticCoastal_Infrastructure_10m_3338.tif')

# Define output file
infra_output = os.path.join(output_folder, 'ArcticCoastal_Infrastructure_10m_3338.tif')
